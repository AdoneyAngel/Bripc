    ...
    render(){
        ...
        return (
            <React.Fragment>
                ...
                {this.state.openMessagesDisplay ? <MessagesBoxDisplay userSel={this.state.userSel} userMail={this.props.userMail} users={this.state.users} close={this.openMessagesDisplay} open={this.state.openMessagesDisplay}/> : setTimeout(()=>{return('')}, 200)}
            </React.Fragment>
        )
    }
}